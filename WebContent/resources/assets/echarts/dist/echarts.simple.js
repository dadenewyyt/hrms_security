...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    clazz.enableClassManagement = function (entity, options) {
	        ...
	        /**
	         * If a main type is container.jsp and has sub types
	         * @param  {string}  mainType
	         * @return {boolean}
	         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Layout helpers for each component positioning
	    ...
	    layout.getLayoutRect = function (
	        ...
	        // 1. Graph should not exceeds the container.jsp
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @example
	 *     var Group = require('zrender/lib/container.jsp/Group');
	    ...
	    Path.prototype = {
	        ...
	        brush: function (ctx) {
	            ...
	            if (this.__dirtyPath || (
	                ...
	                // Setting line dash.jsp before build path
	    ...
	    PathProxy.prototype = {
	        ...
	        _dashedBezierTo: function (x1, y1, x2, y2, x3, y3) {
	            ...
	            while (t <= 1) {
	                ...
	                // Bad result if dash.jsp is long
	         ...
	         * Rebuild path will not consider javascript implemented line dash.jsp.
	         * @param {CanvasRenderingContext} ctx
	         */
	...
	// Global defines
	    ...
	    ZRender.prototype = {
	        ...
	        */
	        ...
	        /**
	         * Resize the canvas.
	         * Should be invoked when container.jsp size is changed
	         */
	        resize: function() {
	            this.painter.resize();
